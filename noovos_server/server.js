...
const get_business_bookings = require('./routes/get_business_bookings');
const get_staff_bookings = require('./routes/get_staff_bookings');
const get_user_bookings = require('./routes/get_user_bookings');
const delete_booking = require('./routes/delete_booking');
...
app.use('/get_business_bookings', get_business_bookings);
app.use('/get_staff_bookings', get_staff_bookings);
app.use('/get_user_bookings', get_user_bookings);
app.use('/delete_booking', delete_booking);
