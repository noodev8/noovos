...
router.post('/', verifyToken, async (req, res) => {
    try {
        ...
        try {
            ...
            for (const entry of entries) {
                await client.query(
                    `INSERT INTO staff_rota (staff_id, rota_date, start_time, end_time, business_id, is_generated)
                     VALUES ($1, $2, $3, $4, $5, $6)`,
                    [entry.staff_id, entry.rota_date, entry.start_time, entry.end_time, business_id, false]
                );
                addedCount++;
            }
